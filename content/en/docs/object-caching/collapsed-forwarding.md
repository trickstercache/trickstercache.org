...
<img src="/images/docs/basic-collapsed-forwarding.png" width="800">
...
<img src="/images/docs/progressive-collapsed-forwarding-cache.png" width="800">

### PCF for Proxy-Only Requests

Trickster provides a unique feature that implements PCF in Proxy-Only configurations, to bring the benefits of Collapsed Forwarding to HTTP Paths that are not configured to be routed through the Reverse Proxy Cache. (See [Paths](/docs/request-handling/paths/) documentation for more info on routing).

The feature is further detailed in the following diagram:

<img src="/images/docs/progressive-collapsed-forwarding-proxy.png" width="800">

## How to enable Progressive Collapsed Forwarding

When configuring path configs as described in [Paths Documentation](/docs/request-handling/paths/) add `collapsed_forwarding: progressive` in any path config using the `proxy` or `proxycache` handlers.

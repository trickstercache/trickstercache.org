...
<img src="/images/docs/deploy-single-everything-1.png" width="605"/>
...
<img src="/images/docs/deploy-multi-origin-1.png" width="762"/>
...
You will need to configure each Trickster-to-TSDB mapping separately in your dashboard application as a separately named TSDB data source. Refer to the [multi-origin](/docs/backends/multi-origin/) documentation for configuring multi-origin support in Trickster and Grafana.
...
<img src="/images/docs/deploy-multi-trickster-1.png" width="611"/>

...
refused-connection, and server-error categories. See [Health Checks](/docs/backends/health/)
...
[`deploy/kube/mysql-user-router-secret.yaml`](https://github.com/trickstercache/trickster/blob/main/deploy/kube/mysql-user-router-secret.yaml)
and replaces the base ConfigMap volume with
[`deploy/kube/mysql-deployment-patch.yaml`](https://github.com/trickstercache/trickster/blob/main/deploy/kube/mysql-deployment-patch.yaml).
...
[`pkg/backends/mysql/testdata/compatibility/v1.json`](https://github.com/trickstercache/trickster/blob/main/pkg/backends/mysql/testdata/compatibility/v1.json). The maintainer-facing frozen release matrix is in
[`docs/developer/mysql-release-contract.md`](https://github.com/trickstercache/trickster/blob/main/docs/developer/mysql-release-contract.md).

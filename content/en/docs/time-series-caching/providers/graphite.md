...
[authenticator](/docs/backends/authenticator/) via `authenticator_name`: the
...
[pkg/backends/graphite/options/defaults.go](https://github.com/trickstercache/trickster/blob/main/pkg/backends/graphite/options/defaults.go)
...
label value comes from a closed set. See [metrics.md](/docs/observability/metrics/).

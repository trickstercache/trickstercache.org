...
Trickster supports enforcing a `max_query_range` limit on InfluxDB backends. For details on how to configure and use query range limits, see the [Query Range Limits](/docs/time-series-caching/query-range-limits/) documentation.

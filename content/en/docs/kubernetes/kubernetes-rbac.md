---
title: "Kubernetes Controller RBAC"
linkTitle: "Controller RBAC"
weight: 50
---
...
([kubernetes-cache-policy.md](/docs/kubernetes/kubernetes-cache-policy/)), installed from
...
[alb-autodiscovery.md](/docs/routing/alb-autodiscovery/). In the `service` routing

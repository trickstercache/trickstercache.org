---
title: "Kubernetes Cache Policy"
linkTitle: "Cache Policy"
weight: 40
---
...
([kubernetes-ingress.md](/docs/kubernetes/kubernetes-ingress/#annotations)), and three things they
...
[deploy/kube/crds/trickstercachepolicies.yaml](https://github.com/trickstercache/trickster/blob/main/deploy/kube/crds/trickstercachepolicies.yaml).
...
1. the GatewayClass's `parametersRef` ([kubernetes-gateway.md](/docs/kubernetes/kubernetes-gateway/#gatewayclass-parameters)), or an Ingress's annotations;
...
([prometheus.md](/docs/time-series-caching/providers/prometheus/), [influxdb.md](/docs/time-series-caching/providers/influxdb/),
[clickhouse.md](/docs/time-series-caching/providers/clickhouse/), [graphite.md](/docs/time-series-caching/providers/graphite/)) for what each accelerates.
...
[paths.md](/docs/request-handling/paths/#cache-key-components). The policy's components reach every caching
...
handled ([trickster-result.md](/docs/observability/trickster-result/)). It is a debugging aid, and on a
...
([paths.md](/docs/request-handling/paths/#hiding-the-result-header)). The disposition is
...
cache ([caches.md](/docs/caching/caches/#redis)) and name it:
...
is ([kubernetes-gateway.md](/docs/kubernetes/kubernetes-gateway/#status)), and by none under

...
([configuring.md](/docs/getting-started/configuring/)) and grant it the permissions in
...
([kubernetes-deploy.md](/docs/kubernetes/kubernetes-deploy/#ports-and-addresses)); an
...
[paths.md](/docs/request-handling/paths/#path-matching-scope).
...
[tls.md](/docs/listeners/tls/#runtime-certificates).
...
[kubernetes-cache-policy.md](/docs/kubernetes/kubernetes-cache-policy/). Anything on the
...
it; see [kubernetes-rbac.md](/docs/kubernetes/kubernetes-rbac/).
...
[alb-autodiscovery.md](/docs/routing/alb-autodiscovery/) for the semantics of both.
...
[kubernetes-gateway.md](/docs/kubernetes/kubernetes-gateway/#leader-election). Without it
...
[kubernetes-gateway.md](/docs/kubernetes/kubernetes-gateway/). Both kinds are served at

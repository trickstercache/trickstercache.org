...
[kubernetes-gateway.md](/docs/kubernetes/kubernetes-gateway/) and
[kubernetes-ingress.md](/docs/kubernetes/kubernetes-ingress/). The Helm chart at
...
| `gateway-rbac.yaml` | ServiceAccount, ClusterRole and binding, and the leader election Role, per [kubernetes-rbac.md](/docs/kubernetes/kubernetes-rbac/) |
...
| `crds/trickstercachepolicies.yaml` | the `TricksterCachePolicy` resource ([kubernetes-cache-policy.md](/docs/kubernetes/kubernetes-cache-policy/)) |
...
[Multiple Configuration Files](/docs/getting-started/configuring/#multiple-configuration-files). It is
...
[Configuring Secrets](/docs/getting-started/configuring/#configuring-secrets-or-sensitive-information):
...
[Listeners](/docs/kubernetes/kubernetes-gateway/#listeners). A deployment that needs
...
[Graceful shutdown](/docs/getting-started/configuring/#graceful-shutdown-and-readiness).

## RBAC

`gateway-rbac.yaml` grants exactly the verbs
[kubernetes-rbac.md](/docs/kubernetes/kubernetes-rbac/) lists, cluster-wide, because the

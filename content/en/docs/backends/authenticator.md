...
Trickster 2.x provides a new Authenticator capability that allows you to protect Backends with an Authentication layer.
...
[MySQL Provider Guide](/docs/time-series-caching/providers/mysql/#direct-backend-configuration).
